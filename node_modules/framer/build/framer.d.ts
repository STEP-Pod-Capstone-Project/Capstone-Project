...
declare type DeepReadonly<T> = {
    readonly [P in keyof T]: T[P] extends Map<infer K, infer V> ? ReadonlyMap<K, V> : T[P] extends Array<infer X> ? ReadonlyArray<X> : DeepReadonly<T[P]>;
};
...
/* Excluded from this release type: _imageScalingMethod */
...
/* Excluded from this release type: shadowForShape */
